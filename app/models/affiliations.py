...
class Affiliation(Base):
    ...
    aliases: Mapped[List["AffiliationAlias"]] = relationship(back_populates="affiliation")
    clarifications: Mapped[List["AffiliationClarification"]] = relationship(back_populates="affiliation")
